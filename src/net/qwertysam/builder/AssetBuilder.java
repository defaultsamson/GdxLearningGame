...
import net.qwertysam.assets.Asset;
...
public class AssetBuilder
{
	 ...
	 */
	public static Sprite createSprite(Assets assets, String key)
	{
	 ...
	 */
	public static List<Sprite> createSprites(Assets assets, String key, int size)
	{
	 ...
	 * @return a List of sprites from a loaded image.
	 */
	public static List<Sprite> createSprites(Assets assets, String key, int xSize, int ySize)
	{
		Asset asset = assets.getAsset(key);
		Class<Texture> requiredType = Texture.class;
	 ...
	 */
	public static BitmapFont createFont(Assets assets, String key, int size)
	{
	 ...
	 * @return a font from a loaded TrueTypeFont file.
	 */
	public static BitmapFont createFont(Assets assets, String key, Color colour, int size)
	{
		Asset asset = assets.getAsset(key);
	 ...
	 */
	public static Sound createSound(Assets assets, String key)
	{
		Asset asset = assets.getAsset(key);
