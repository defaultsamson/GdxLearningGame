...
public class OptionsScreen extends GuiScreen
{
	...
	public void init()
	{
		...
		registerEntry(new GuiTextButton(this, game.assets().button_small, game.assets().ubuntu.white_medium.normal, 8F, 1, 40, 400, 30, 50, TranslationKey.GUI_BUTTON_LANGUAGE.translate(game)));
		registerEntry(new GuiTextButton(this, game.assets().button_small, game.assets().ubuntu.white_medium.normal, 8F, 2, 40, 150, 30, 50, TranslationKey.GUI_BUTTON_BACK.translate(game)));
	}
